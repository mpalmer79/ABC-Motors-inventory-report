...
const shouldSubgroup = (model: string): boolean => {
    return model === "SILVERADO 1500" || model === "SILVERADO 2500HD" || model === "SILVERADO 3500HD" ||
          model === "SIERRA 1500" || model === "SIERRA 2500HD" || model === "SIERRA 3500HD";
};
                                                                                                ...
                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div className="grid grid-cols-2 gap-2 text-xs">
                                                                                                                                          <div className="flex justify-between">
                                                                                                                                                                  <span className="text-muted-foreground">Trim</span>span>
                                                                                                                                                                  <span>{r.Trim}</span>span>
                                                                                                                                            </div>div>
                                                                                                                                          <div className="flex justify-between">
                                                                                                                                                                  <span className="text-muted-foreground">Exterior</span>span>
                                                                                                                                                                  <span>{r["Exterior Color"]}</span>span>
                                                                                                                                            </div>div>
                                                                                                                                          <div className="flex justify-between">
                                                                                                                                                                  <span className="text-muted-foreground">Model #</span>span>
                                                                                                                                                                  <span>{r["Model Number"]}</span>span>
                                                                                                                                            </div>div>
                                                                                                                                          <div className="flex justify-between">
                                                                                                                                                                  <span className="text-muted-foreground">Age</span>span>
                                                                                                                                                                  <span className={isInTransit(r) ? "text-amber-500 font-semibold" : ""}>
                                                                                                                                                                    {formatAgeShort(r)}{!isInTransit(r) && " days"}
                                                                                                                                                                    </span>span>
                                                                                                                                            </div>div>
                                                                                                                                          <div className="flex justify-between col-span-2">
                                                                                                                                                                  <span className="text-muted-foreground">MSRP</span>span>
                                                                                                                                                                  <span className="font-semibold">${Number(r.MSRP).toLocaleString()}</span>span>
                                                                                                                                            </div>div>
                                                                                                                      </div>div>
                                                                                                  </div>div>
                                                                                              ))}
                        ...
                        <div className="overflow-x-auto">
                                  <table className="w-full">
                                              <thead>
                                                            <tr className="border-b bg-muted/50">
                                                                            <th className="text-left p-3 text-xs font-semibold uppercase tracking-wide text-muted-foreground">Stock #</th>th>
                                                                            <th className="text-left p-3 text-xs font-semibold uppercase tracking-wide text-muted-foreground">Year</th>th>
                                                                            <th className="text-left p-3 text-xs font-semibold uppercase tracking-wide text-muted-foreground">Model</th>th>
                            ...
                            <React.Fragment key={`${group.year}-${group.model}-${group.modelNumber}`}>
                                              <tr className="bg-primary/10 border-t-2 border-primary/30">
                                                                  ...
                                                                  <td className="p-3 text-xs font-semibold uppercase tracking-wide text-muted-foreground">Exterior Color</td>td>
                                                                  <td className="p-3 text-xs font-semibold uppercase tracking-wide text-muted-foreground">Trim</td>td>
                                                                  <td className="p-3 text-xs font-semibold uppercase tracking-wide text-muted-foreground">Model #</td>td>
                                                                  <td className="p-3 text-xs font-semibold uppercase tracking-wide text-muted-foreground">Age</td>td>
                                                                  <td className="p-3 text-xs font-semibold uppercase tracking-wide text-muted-foreground">MSRP</td>td>
                                              </tr>tr>
                              {group.rows.map((r) => (
                                                  <tr
                                                                          key={r["Stock Number"]}
...
InventoryTable.displayName = "InventoryTable";</Card>
