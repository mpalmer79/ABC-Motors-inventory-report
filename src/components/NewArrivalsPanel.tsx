                                                        ...
                                                        <Card className="mb-6">
                                                              <CardHeader className="pb-3">
                                                                      <CardTitle className="flex items-center gap-2 text-base">
                                                                                ...
                                                                                <Badge variant="secondary" className="ml-2">{rows.length}</Badge>Badge>
                                                                      </CardTitle>CardTitle>
                                                              ...
                                                              <CardContent>
                                                                      ...
                                                                      <div
                                                                                    ...
                                                                                    <div className="flex items-center gap-4 text-sm text-muted-foreground">
                                                                                                    <span className="hidden sm:inline">{row["Exterior Color"] || "Color TBD"}</span>span>
...
NewArrivalsPanel.displayName = "NewArrivalsPanel";</Card>
