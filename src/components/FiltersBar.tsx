                                                        ...
                                                        <div className="flex flex-wrap items-end gap-2 md:gap-4">
                                                          {/* DEALERSHIP */}
                                                                <div className="w-full md:w-auto md:min-w-[160px]">
                                                                          <label className={dealerLabelClass}>Choose Dealership</label>label>
                                                          ...
                                                          {/* YEAR */}
                                                                <div className="flex-1 min-w-[80px] md:flex-none md:min-w-[100px]">
                                                                          <label className={labelClass}>Year</label>label>
                                                                          <Select value={filters.year} onValueChange={(v) => onChange({ year: v })}>
                                                                                      <SelectTrigger className="h-9 md:h-10">
                                                                                                    <SelectValue placeholder="All Years" />
                                                                                      </SelectTrigger>SelectTrigger>
                                                                                      <SelectContent>
                                                                                                    <SelectItem value="ALL">All Years</SelectItem>SelectItem>
                                                                                        {years.map((y) => (
                                                          ...
                                                          {/* MAKE */}
                                                                <div className="flex-1 min-w-[80px] md:flex-none md:min-w-[120px]">
                                                                          <label className={labelClass}>Make</label>label>
                                                                          <Select
                                                                                      ...
                                                                                      <SelectContent>
                                                                                                    <SelectItem value="ALL_MAKES">All Makes</SelectItem>SelectItem>
                                                                                        {makes.map((m) => (
                                                          ...
                                                          {/* MODEL */}
                                                                <div className="flex-1 min-w-[80px] md:flex-none md:min-w-[140px]">
                                                                          <label className={labelClass}>Model</label>label>
                                                                          <Select
                                                                                      ...
                                                                                      <SelectContent>
                                                                                                    <SelectItem value="ALL_MODELS">All Models</SelectItem>SelectItem>
                                                          ...
                                                          {/* STOCK NUMBER */}
                                                                <div className="flex-1 min-w-[80px] md:flex-none md:min-w-[140px]">
                                                                          <label className={labelClass}>
                                                                                      <span className="hidden md:inline">Stock Number</span>span>
                                                                                      <span className="md:hidden">Stock #</span>span>
                                                                          </label>label>
                                                                          <Input
                                                                                        type="text"
                                                                                        placeholder="Search..."
                                                          ...
                                                          {/* ACTIONS */}
                                                                <div className="w-full md:w-auto flex items-end gap-2 md:gap-3 md:ml-auto mt-2 md:mt-0">
                                                                          <Button variant="default" className="gap-2 h-9 md:h-10 flex-1 md:flex-none">
                                                                                      ...
                                                                                      <span className="md:inline">Search</span>span>
                                                                          </Button>Button>
                                                                          <ThemeToggle />
                                                                </div>div>
                                                        </div>div>
...
FiltersBar.displayName = "FiltersBar";</Card>
