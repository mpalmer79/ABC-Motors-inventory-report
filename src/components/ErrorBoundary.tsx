        ...
        if (this.state.hasError) {
                ...
                return (
                          <div style={{
                                      ...
                                      <div style={{ fontSize: "48px", marginBottom: "16px" }}>⚠️</div>div>
                                      <h2 style={{
                                        fontSize: "20px",
                                        fontWeight: 600,
                                        color: "#ef4444",
                                        marginBottom: "8px",
                          }}>Something went wrong</h2>h2>
                                      <p style={{
                                        fontSize: "14px",
                                        color: "#9ca3af",
                                        marginBottom: "20px",
                                        ...
                                        margin: "0 auto 20px",
                                                    ...
                                                    An unexpected error occurred while loading this section. Please try again or refresh the page.
                                      </p>p>
                            {this.state.error && (
                                        <details style={{
                                                        textAlign: "left",
