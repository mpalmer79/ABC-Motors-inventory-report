...
const DetailRow: FC<{ label: string; value: string | number; icon?: React.ReactNode }> = ({
    ...
    <div className="flex items-center justify-between py-2.5 border-b border-border last:border-0">
        ...
        <span className="text-sm font-medium">{value}</span>span>
    </div>div>
  );
                ...
                <SheetContent className="overflow-y-auto">
                        <SheetHeader className="pb-4">
                                  ...
                                  <SheetDescription className="flex items-center gap-2">
                                              ...
                                              <Badge variant={agingVariant}>{vehicle.Age} days</Badge>Badge>
                                              ...
                                              <Card>
                                                            <CardContent className="p-4">
                                                                            ...
                                                                            <div className="pt-2.5">
                                                                                              <span className="text-sm text-muted-foreground block mb-1">VIN</span>span>
...
VehicleDetailDrawer.displayName = "VehicleDetailDrawer";</div>
